...
set CATFilepath=C:\Users\DESKTOP\Downloads\Part2.CATPart
set CrvSetName="CRV"
set AxisSetName="AXISS"

rem 以下内容请勿修改
"%CATPath%\win_b64\code\bin\CATSTART.exe" -run "%MyPath%win_b64\code\bin\%ModuleName% %CATFilepath% %CrvSetName% %AxisSetName%" -env %CATEnvName% -direnv %CATEnvPath%
